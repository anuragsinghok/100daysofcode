...
# Activate the virtual environment (Linux/mac05)
...
# computer ke python ki copy bn chuki hai ek version kisi aur ka aur ek kisi aur ka dal skta hu ab mai

#-------------note: not full understand unable to know it how it it works frustating going to try again tommorow and update it here